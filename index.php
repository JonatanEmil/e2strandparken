        ...
        <div class="col-6">
            ...
            <div class="position-relative"> <!-- position-relative: Denne plads er stadig gemt i dokumentet. Dens children er positioneret relativt til dette element nu med css.-->
                ...
                <div class="row position-absolute d-flex justify-content-center dtext text-center"> <!-- postion-absolute: Denne plads er ikke gemt (ligesom et overlay). d-text er vores egen klasse (se styles.scss) -->
                    ...
                    <div class="col-5 ms-4 ps-5 my-4 pb-2"><a href="booking-blossom.php?navn=Book tid i Blossom" class="link-hvid">Restaurant <br> Blossom</a></div>
                    <div class="col-5 pe-5 me-4 my-4 pb-2"><a href="forlaeng-ophold.php?navn=Forlænd Ophold" class="link-hvid">Forlæng <br> Ophold</a></div>
                    ...
                    <div class="col-12 mt-5"><a href="booking-museum.php?navn=Book til Holbæk Museum" class="link-hvid">Book <br> museums <br> besøg</a></div>
                </div>
            </div>
        </div>
    </div>
